    ...
    <div className="p-3 m-2 overflow-hidden mx-auto max-h-80 overflow-y-auto border-indigo-500 bg-neutral-800 rounded">
      <ul>
        {editais.map((edital) => (
          <li
            key={edital.id}
            className="transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:translate-x-32  hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50 hover:bg-sky-600 bg-blend-screen py-2 pl-2 pb-2 last:border-none hover:bg-sky-700"
          >
